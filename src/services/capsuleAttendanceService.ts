...
export interface CapsuleAttendanceAggregates {
  clusterMonthMap: Record<string, { totalNotified: number; totalAttended: number; months: Record<string, CapsuleMonthMapNode>; teams: Record<string, { totalNotified: number; totalAttended: number; months: Record<string, CapsuleMonthMapNode> }> }>;
  globalKPIs: {
...
export function buildCapsuleAttendanceMatrix(
  ...
  const clusterMonthMap: CapsuleAttendanceAggregates['clusterMonthMap'] = {};
